...
# OOF: Reserve space for each sample in the training set
...
oof_df.to_csv("oof_predictions_train_xgb.csv", index=False, encoding="utf-8-sig")
print("OOF predictions for training saved as 'oof_predictions_train_xgb.csv'")
...
joblib.dump(final_model, 'final_xgb_model_refit_on_full_train.pkl')
print("\nFinal XGBoost model saved as 'final_xgb_model_refit_on_full_train.pkl'")
...
test_df = pd.DataFrame({
    ...
    "y_true": y_test,
    "y_pred_test_xgb": y_pred_test_final
})
...
test_df.to_csv("predictions_test_xgb.csv", index=False, encoding="utf-8-sig")
print("Test set predictions saved as 'predictions_test_xgb.csv'")
